...
# Charge mode
    ...
    tca6507.set_led_param(FULLYON,{"BANK0":6,"BANK1":1})
    tca6507.set_led_param(FIRSTFULLYOFF,{"BANK0":4,"BANK1":1})
    tca6507.set_led_param(SECONDFULLYOFF,{"BANK0":4,"BANK1":10})
    tca6507.set_led_param(FADEON,{"BANK0":9,"BANK1":11})
    tca6507.set_led_param(FADEOFF,{"BANK0":9,"BANK1":9})
    tca6507.set_led_param(MAXINTENSITY,{"BANK0":1,"BANK1":1})
    tca6507.set_led(["LED1","LED2","LED3","LED4","LED5","LED6","LED7"],LED_OFF)
    tca6507.set_led(["LED0"],LED_BLINK_0)
    tca6507.update_led()

#Low Bat
    tca6507.set_oneshot_masterint_param({"ALD_INTENSITY":15,"ALD_EN_PWM0":0,"ALD_EN_PWM1":0,"ONE_SHOT_PWM0":0,"ONE_SHOT_PWM1":0})
    tca6507.set_led_param(FULLYON,{"BANK0":2,"BANK1":1})
    tca6507.set_led_param(FIRSTFULLYOFF,{"BANK0":3,"BANK1":1})
    tca6507.set_led_param(SECONDFULLYOFF,{"BANK0":8,"BANK1":10})
    tca6507.set_led_param(FADEON,{"BANK0":2,"BANK1":1})
    tca6507.set_led_param(FADEOFF,{"BANK0":2,"BANK1":1})
    tca6507.set_led_param(MAXINTENSITY,{"BANK0":1,"BANK1":1})
    tca6507.set_led(["LED0","LED2","LED3","LED4","LED5","LED6","LED7"],LED_OFF)
    tca6507.set_led(["LED1"],LED_BLINK_0)
    tca6507.update_led()

    # BLE connectable
    tca6507.set_oneshot_masterint_param(
        {"ALD_INTENSITY": 15, "ALD_EN_PWM0": 0, "ALD_EN_PWM1": 0, "ONE_SHOT_PWM0": 0, "ONE_SHOT_PWM1": 0})
    tca6507.set_led_param(FULLYON, {"BANK0": 2, "BANK1": 2})
    tca6507.set_led_param(FIRSTFULLYOFF, {"BANK0": 3, "BANK1": 4})
    tca6507.set_led_param(SECONDFULLYOFF, {"BANK0": 8, "BANK1": 4})
    tca6507.set_led_param(FADEON, {"BANK0": 2, "BANK1": 1})
    tca6507.set_led_param(FADEOFF, {"BANK0": 2, "BANK1": 1})
    tca6507.set_led_param(MAXINTENSITY, {"BANK0": 15, "BANK1": 10})
    tca6507.set_led(["LED0", "LED1", "LED3", "LED4", "LED5", "LED6", "LED7"], LED_OFF)
    ...
    tca6507.set_oneshot_masterint_param(
        {"ALD_INTENSITY": 15, "ALD_EN_PWM0": 0, "ALD_EN_PWM1": 0, "ONE_SHOT_PWM0": 0, "ONE_SHOT_PWM1": 0})
    tca6507.set_led_param(FULLYON, {"BANK0": 2, "BANK1": 2})
    tca6507.set_led_param(FIRSTFULLYOFF, {"BANK0": 3, "BANK1": 10})
    tca6507.set_led_param(SECONDFULLYOFF, {"BANK0": 8, "BANK1": 10})
    tca6507.set_led_param(FADEON, {"BANK0": 2, "BANK1": 1})
    tca6507.set_led_param(FADEOFF, {"BANK0": 2, "BANK1": 1})
    tca6507.set_led_param(MAXINTENSITY, {"BANK0": 15, "BANK1": 10})
    ...
    tca6507.set_led_param(FADEON, {"BANK0": 2, "BANK1": 1})
    tca6507.set_led_param(FADEOFF, {"BANK0": 2, "BANK1": 1})
    tca6507.set_led_param(MAXINTENSITY, {"BANK0": 1, "BANK1": 10})
    tca6507.set_led(["LED0","LED1","LED2","LED3","LED4" ,"LED5", "LED6", "LED7"], LED_OFF)
    tca6507.set_led([ "LED2"], LED_ON_PWM0)
    tca6507.update_led()
